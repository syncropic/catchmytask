...
export function Sync<T extends Record<string, any>>({
  setActionType,
  action_options,
  identity,
  data_items,
  ...
  const getFilesFromDirectory = async (directoryHandle, filetype) => {
    const filesProcessed = [];
  ...
  const handleFolderSelection = async () => {
    ...
    try {
      ...
      console.log("filesFromDirectory", filesFromDirectory);
  ...
  // console.log("data_items", data_items);
  // console.log("filteredrows", data_table?.getFilteredRowModel().rows);
  const handleSubmit = (e: any) => {
    const current_view_items = data_table
      ?.getFilteredRowModel()
      .flatRows.map((row) => row.original);
    // console.log("current_view_items", current_view_items);
  ...
  return (
    ...
    >
      ...
      <MultiSelect
        ...
        label="source"
        placeholder="Select source"
        data={locationTypeOptions} // Replace with your options source
