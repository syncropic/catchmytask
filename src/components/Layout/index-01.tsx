...
import { Accordion, Button, Tabs, Textarea } from "@mantine/core";
import {
  Authenticated,
  HttpError,
  useGo,
        ...
        <PanelGroup direction="horizontal">
          {activeLayout?.leftSection?.isDisplayed && (
            <Panel defaultSize={20} minSize={0} id="left">
              ...
              >
                <Accordion
                  defaultValue={["recommendations_window"]}
                  multiple={true}
                >
                  {/* <Accordion.Item
            ...
            <>
              ...
              <Panel defaultSize={60} minSize={30} id="middle">
                ...
                >
                  ...
                  >
                    {/* <Accordion.Item
                      key="generative_scratchpad"
                      value="generative_scratchpad"
                    >
                      <Accordion.Control icon={<IconChalkboard size={16} />}>
                        Scratchpad
                      </Accordion.Control>
                      <Accordion.Panel>
                       
                        <Tabs defaultValue="plans" orientation="vertical">
                          <Tabs.List>
                          ...
                          <Tabs.Panel value="plans">
                            <Tabs defaultValue="plan_1">
                              <Tabs.List>
                                <Tabs.Tab value="plan_1">Plan 1</Tabs.Tab>
                                <Tabs.Tab value="plan_2">Plan 2</Tabs.Tab>
                                <Tabs.Tab value="plan_3">Plan 3</Tabs.Tab>
                              </Tabs.List>
                              <Tabs.Panel value="plan_1" pb="xs">
                                <GenerativeComponentWrapper
                                  type="plans"
                                  response_model="StructuredPlan"
                                  object_to_list_of_records_with_uuid={true}
                                  // data_key="content"
                                  instruction="generate structured plan"
                                  data_fields={[
                                    {
                                      name: "content",
                                      accessor: "content",
                          ...
                          <Tabs.Panel value="searches">
                            ...
                            <GenerativeComponentWrapper
                              type="searches"
                              response_model="RelevantSearches"
                              object_to_list_of_records_with_uuid={false}
                              data_key="searches"
                            ></GenerativeComponentWrapper>
                            <div>relevant search queries</div>
                          </Tabs.Panel>
                        </Tabs>
                      </Accordion.Panel>
                    </Accordion.Item> */}
                    {/* <Accordion.Item key="indicators" value="indicators">
                      <Accordion.Control icon={<IconListCheck size={16} />}>
                        Indicators
                      </Accordion.Control>
                      <Accordion.Panel>
                        <Tabs
                          defaultValue="natural_language_query"
                          orientation="vertical"
                        >
                          <Tabs.List>
                            <Tabs.Tab value="natural_language_query">
                          ...
                          <Tabs.Panel value="natural_language_query">
                            <GenerativeComponentWrapper
                              type="reviews"
                          ...
                          <Tabs.Panel value="plan_1">
                            <div>plan analysis and other indicators</div>
                          </Tabs.Panel>
                          <Tabs.Panel value="plan_2">
                            <div>plan analysis and other indicators</div>
                          </Tabs.Panel>
                          <Tabs.Panel value="plan_3">
                            <div>plan analysis and other indicators</div>
                          </Tabs.Panel>
                        </Tabs>
                      </Accordion.Panel>
            ...
            <>
              ...
              <Panel defaultSize={20} minSize={0} id="right">
                ...
                >
                  ...
                  <Accordion
                    defaultValue={["state_view", "generative_recommendations"]}
                    multiple={true}
                  >
                    {/* <Accordion.Item key="state_view" value="state_view">
                      <Accordion.Control
                        icon={<IconWashTemperature4 size={16} />}
                      >
                        State View
                      </Accordion.Control>
                      <Accordion.Panel>
                    ...
                    {/* <Accordion.Item
                      key="synthesize_selection"
                      value="synthesize_selection"
                    >
                      <Accordion.Control icon={<IconLanguage size={16} />}>
                    ...
                    {/* <Accordion.Item key="action_input" value="action_input">
                      <Accordion.Control icon={<IconMathFunction size={16} />}>
                        Action Input
                      </Accordion.Control>
                      <Accordion.Panel>
                        <ActionInput></ActionInput>
                    ...
                    {/* <Accordion.Item
                      key="generative_recommendations"
                      value="generative_recommendations"
                    >
                      <Accordion.Control icon={<IconUserPlus size={16} />}>
                        Generative Recommendations
                      </Accordion.Control>
                      <Accordion.Panel>
                        <Recommendations mode="generative"></Recommendations>
                      </Accordion.Panel>
                    </Accordion.Item> */}
                  </Accordion>
                </div>
