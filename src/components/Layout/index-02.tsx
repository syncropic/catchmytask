        ...
        <PanelGroup direction="horizontal">
          {activeLayout?.leftSection?.isDisplayed && (
            <Panel defaultSize={20} minSize={0} id="left">
              ...
              >
                <Accordion
                  defaultValue={["search_tasks", "search_action_steps"]}
                  multiple={true}
                >
            ...
            <>
              ...
              <Panel defaultSize={20} minSize={0} id="right">
                ...
                >
                  ...
                  <Accordion
                    defaultValue={["natural_language_query_indicator"]}
                    multiple={true}
                  >
                    <Accordion.Item
                    ...
                    <Accordion.Item
                      key="action_plan_indicator"
                      value="action_plan_indicator"
                    >
                      <Accordion.Control icon={<IconGauge size={16} />}>
                    ...
                    <Accordion.Item
                      key="results_indicator"
                      value="results_indicator"
                    >
                      <Accordion.Control icon={<IconGauge size={16} />}>
                        Results Indicator
                      </Accordion.Control>
