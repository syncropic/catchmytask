...
export function RecommendationsGraph() {
  ...
  const handleSubmit = (e: any) => {
    ...
    //   method: "post",
    //   config: {
    //     payload: generateRequestData(values),
    //   },
    //   successNotification: (data, values) => {
    //     // console.log("successNotification", data);
    //     // invalidate query
    ...
    <>
      ...
      >
        ...
        <div>
          ...
          look at, what to avoid e.t.c based on the query graph, recent action
          and corresponding execution trace, and user profile and preferences
        </div>
      </Create>
    </>
  );
...
export default RecommendationsGraph;
