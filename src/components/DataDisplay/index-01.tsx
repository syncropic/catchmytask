              ...
              >
                <div className="flex w-full">
                  ...
                  {/* <DebouncedInput
                    ...
                    onChange={(value) => setGlobalFilter(String(value))}
                    className="w-full p-2 font-lg shadow border border-block"
                    placeholder="sql results..."
                  /> */}
                  {/* <RecordsActionWrapper
                    name="action_step"
                    query_name="data_model"
                    success_message_code="action_input_data_model_schema"
                    include_form_components={[
                      "execute selected icon",
                      "implement selected icon",
                      "follow up prompt selected icon",
                    ]}
                  ...
                  <Tabs defaultValue="follow up prompt selected">
                    <Tabs.List>
                      ...
                      <Tabs.Tab value="implement selected">
                        <ActionInputWrapper
                          name="task"
                          query_name="data_model"
                          record={record}
                          include_form_components={["implement selected icon"]}
                          success_message_code="action_input_data_model_schema"
                          update_action_input_form_values_on_submit_success={
                            true
                          }
                      ...
                      <Tabs.Tab value="execute selected">
                        <ActionInputWrapper
                          ...
                          query_name="data_model"
                          record={record}
                          include_form_components={["execute selected icon"]}
                          success_message_code="action_input_data_model_schema"
                          update_action_input_form_values_on_submit_success={
                            true
                          }
                      ...
                      <Tabs.Tab value="cancel execution selected">
                        <ActionInputWrapper
                          ...
                          record={record}
                          include_form_components={[
                            "cancel execution selected icon",
                          ]}
                          success_message_code="action_input_data_model_schema"
                          update_action_input_form_values_on_submit_success={
                            true
                    ...
                    <Tabs.Panel value="search all fields" pt="xs">
                      <DebouncedInput
                        value={globalFilter ?? ""}
                        onChange={(value) => setGlobalFilter(String(value))}
                        className="w-full p-2 font-lg shadow border border-block"
                    ...
                    <Tabs.Panel value="implement selected" pt="xs">
                      implement selected
                    </Tabs.Panel>
