          ...
          <Tabs.List>
            <Tabs.Tab value="follow up prompt selected">
              ...
              {/* <ActionInputWrapper
                ...
                record={record}
                include_form_components={["follow up prompt selected icon"]}
            ...
            <Tabs.Tab value="save selected">
              <ActionInputWrapper
                ...
                query_name="data_model"
                record={record}
                include_form_components={["save selected icon"]}
                success_message_code="action_input_data_model_schema"
                update_action_input_form_values_on_submit_success={true}
                nested_component={{
                  data_model: {
            ...
            <Tabs.Tab value="share selected">
              <ActionInputWrapper
                ...
                query_name="data_model"
                record={record}
                include_form_components={["share selected icon"]}
                success_message_code="action_input_data_model_schema"
                update_action_input_form_values_on_submit_success={true}
                nested_component={{
                  data_model: {
            ...
            <Tabs.Tab value="cancel execution selected">
              <ActionInputWrapper
                ...
                query_name="data_model"
                record={record}
                include_form_components={["cancel execution selected icon"]}
                success_message_code="action_input_data_model_schema"
                update_action_input_form_values_on_submit_success={true}
                nested_component={{
                  data_model: {
