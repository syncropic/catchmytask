...
import { ActionStep, BoardItem, useBoardContext } from "@components/Board";
...
function MoveToOtherColumnItem({
  ...
  const onClick = useCallback(() => {
    moveCard({
      ...
      finishColumnId: targetColumn.id,
      itemIndexInStartColumn: startIndex,
    });
  }, [columnId, moveCard, startIndex, targetColumn.id]);

  return <DropdownItem onClick={onClick}>{targetColumn.name}</DropdownItem>;
}
...
export const Card = memo(function Card({ item }: { item: BoardItem }) {
