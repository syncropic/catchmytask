...
export const PageShow = ({
  ...
  //   console.log("executing_record", executing_record);
  ...
  //   console.log("execute_data", executeData);
  ...
  return (
    <>
      ...
      >
        ...
        <Accordion defaultValue={default_display_component}>
          ...
          {display_components.includes("actions") && (
          ...
          {/* {display_components.includes("files") && (
            <Accordion.Item key="files" value="files">
              <Accordion.Control icon={<IconFiles />}>Files</Accordion.Control>
              <Accordion.Panel>
                {JSON.stringify(
                  // Object.keys(record?.files?.[0] || {}).map((item, index) => ({
                  //   id: index,
                  //   field_name: item,
                  //   display: true,
                  // }))
                ...
                <TableView
                  ...
                  activeQueryResults={{ data: record?.files }}
                ></TableView>
              </Accordion.Panel>
            </Accordion.Item>
          )} */}
        ...
        {/* <TableView
          ...
          data_columns={[
            ...
            // { id: 2, field_name: "globals", visible: true },
            // { id: 3, field_name: "imports", visible: true },
            { id: 4, field_name: "path", visible: true, data_type: "string" },
          ]}
          activeQueryResults={{ data: record?.files }}
        ></TableView> */}
      </Show>
