...
interface SelectViewAsComponentProps {
  viewAsValue: string;
  setViewAsValue: (value: string) => void;
}
...
function SelectViewAs({
  viewAsValue,
  setViewAsValue,
}: SelectViewAsComponentProps) {
  ...
  return (
    <>
      ...
      <Combobox
        ...
        resource="view"
        value={viewAsValue}
        setValue={setViewAsValue}
      ></Combobox>
    </>
  );
}

export default SelectViewAs;
