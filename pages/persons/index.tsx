...
import { IPerson } from "pages/persons/interfaces";
...
export const PageList: React.FC<IResourceComponentsProps> = () => {
  ...
  const data_columns = useMemo<MRT_ColumnDef<IPerson>[]>(
    () => [
      {
        accessorKey: "id",
        header: "id",
      ...
      //           go({
      //             to: {
      //               resource: "persons", // resource name or identifier
      //               action: "show",
      //               id: row.original.id,
      //             },
      //             type: "push",
