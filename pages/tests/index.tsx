...
export const PageList: React.FC<IResourceComponentsProps> = () => {
  ...
  const columns = useMemo<MRT_ColumnDef<IReport>[]>(
    () => [
      ...
      // { accessorKey: "caesars_rewards_number", header: "cr_number" },
      // { accessorKey: "flight_class", header: "flight_class" },
      // { accessorKey: "flight_stops", header: "flight_stops" },
      // {
      //   accessorKey: "hotel",
      //   header: "hotel",
      //   Cell: ({ row }) => <Text size="sm">{Reveal(row.original.hotel)}</Text>,
      // },
      {
