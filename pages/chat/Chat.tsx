...
export const Chat: React.FC<IResourceComponentsProps> = () => {
  const go = useGo();
  ...
  return (
    <div className="w-max-screen">
      ...
      Ask questions and execute actions for specific records or groups of
      records using natural language. <b>Coming soon</b>
    </div>
  );
};
export default Chat;
