import { GitHubBanner, ITreeMenu, Refine, useMenu } from "@refinedev/core";
...
// Dynamically import the CopilotKit component, disabling SSR
...
//   url: `${process.env.NEXT_PUBLIC_CMT_API_BASEURL}/graphql`
// });
...
const App = (props: React.PropsWithChildren) => {
  ...
  return (
    <>
      <DevtoolsProvider>
        <CopilotKit url="http://localhost:4201">
          {/* <CopilotSidebar> */}
          {/* <SomeReactComponent /> */}
          <NotificationsProvider position="top-right">
            <Refine
              ...
              resources={[
                ...
                {
                  name: "caesars_payments",
                  list: "/caesars_payments",
                  create: "/caesars_payments/create",
                  edit: "/caesars_payments/edit/:id",
                  show: "/caesars_payments/show/:id",
                  meta: {
                    canDelete: true,
                    hide: true,
                    dataProviderName: "catchmytaskApiDataProvider",
                ...
                },
                {
                  name: "queue_items",
                  list: "/queue_items",
                  create: "/queue_items/create",
                  edit: "/queue_items/edit/:id",
                  show: "/queue_items/show/:id",
                  meta: {
                    canDelete: true,
                    hide: true,
                    dataProviderName: "catchmytaskApiDataProvider",
                ...
                },
                {
                  ...
                  meta: {
                    ...
                    hide: true,
                    // dataProviderName: "catchmyvibeApiDataProvider",
                    data_model: "data_models:3o15f4q9kaaa43mf3hpo",
                  },
                },
                {
                  name: "airlines",
                  list: "/airlines",
                  create: "/airlines/create",
                  edit: "/airlines/edit/:id",
                  show: "/airlines/show/:id",
                  meta: {
                    canDelete: true,
                    hide: true,
                    // dataProviderName: "catchmyvibeApiDataProvider",
                ...
                },
                {
                  ...
                  meta: {
                    canDelete: true,
                    hide: true,
                    dataProviderName: "catchmytaskGraphqlApiDataProvider",
                    // data_model: "data_models:3o15f4q9kaaa43mf3hpo",
                  },
                },
                // {
...
function MyApp({
  ...
  const renderComponent = () => {
    ...
    //   return (
    //     <>
    //       {items.map(({ key, name, children, list, meta, route }) => {
    //         if (!list) {
    //           return (
    //             <li key={meta?.label}>
    ...
    return (
      ...
      //     <Panel defaultSize={15} minSize={0}>
      //       <ShortcutList />
      //       <ViewList />
