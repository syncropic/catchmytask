...
export const PageList: React.FC<IResourceComponentsProps> = () => {
  ...
  const columns = useMemo<MRT_ColumnDef<IMessage>[]>(
    () => [
      // {
      //   id: "actions",
      //   accessorKey: "id",
      ...
      {
        accessorKey: "to_email_list",
        header: "to_email_list",
        // Cell: ({ row }) => (
        //   <Anchor component={Text}>
        //     <Text
        //       size="sm"
      ...
      { accessorKey: "cc_email_list", header: "cc_email_list" },
