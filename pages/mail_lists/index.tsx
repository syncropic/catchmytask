...
export const PageList: React.FC<IResourceComponentsProps> = () => {
          ...
          <Anchor component={Text}>
            <Text
              ...
              onClick={() => {
                go({
                  to: {
                    resource: "mail_lists", // resource name or identifier
                    action: "show",
                    id: row.original.id,
                  },
                  type: "push",
  ...
  const table = useMantineReactTable({
    ...
    renderDetailPanel: ({ row }) => (
      <div>
        <Text>
          <b>From :</b> david.wanjala@snowstormtech.com
        </Text>
        <Text>
          <b>To :</b>{" "}
          {row.original.name === "personal"
            ? identity?.email
            : row.original.to_email_list}
        </Text>
        <Text>
          <b>CC :</b> {row.original.cc_email_list}
        </Text>
      </div>
    ),
